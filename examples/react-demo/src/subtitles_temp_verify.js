...
const translations = {
  ...
  sq: [
    ...
    "Mund të rregullon shpejtësinë e luajtjes, të zgjidhni titrat ose të ndryshoni përkthimet audio."
  ],
  am: [
    "ወደ ብጁ የ-AI ቪዲዮ መማሪያ የስራ ቦታ እንኳን በደህና መጡ።",
    "ይህ ማጫወቻ ያለምንም የቪዲዮ መለያዎች ሙሉ በሙሉ በሸራ ማ야 ገጽ ላይ ይሰራል።",
    "የማጫወቻ ፍጥነትን ማስተካከል፣ የትርጉም ጽሑፎችን መምረጥ அல்லது የድ음ጽ ትርጉሞችን መቀየር ይችላሉ።"
  ],
  ar: [
  ...
  hy: [
    ...
    "Այս նվագարկիչն ամբողջությամբ աշխատում է կտավի էկրանին՝ առանց որևէ տեսատեգերի:",
  ...
  bn: [
    ...
    "আপনি প্লেব্যাকের গতি সমন্বय করতে পারেন, সাবটাইটেল নির্বাচন করতে পারেন বা অডিও অনুবাদ পরিবর্তন করতে পারেন।"
  ],
  bho: [
  ...
  ca: [
    "Benvingut a l'espai de travail personalitzat de l'AI Video Tutor.",
    "Aquest reproductor funciona completament en una pantalla de llenç sense cap etiqueta de vídeo.",
    "Podeu ajustar la velocitat de reproducció, seleccionar els subtítols o canviar les traduccions d'audio."
  ],
  ceb: [
  ...
  gu: [
    ...
    "તમે प્લેબેક રેટને સમાયોજિત કરી શકો છો, સબટાઈટલ પસંદ કરી શકો છો અથવા ઑડિઓ અનુવાદ બદલી શકો છો."
  ],
  ha: [
  ...
  he: [
    "ברוכים הבאים לסביבת העבודה המותאמת אישית של AI Video Tutor.",
    "נגן זה פועל לחלוטין על גבי מסך קנבס ללא תגי וידאו כלשהם.",
    "באפשרותכם לכוונן את מהירות הניגון, לבחור כתוביות או להחליף תרגומי שמע."
  ],
  hi: [
  ...
  ig: [
    ...
    "Ihe ọkpụkpọ a na-agba kpamkpam na ihuenyo canvas na-enweghï mkpado vidiyo ọ bụla.",
  ...
  km: [
    "សូមស្វាគมន៍មកកាន់កន្លែងធ្វើការ AI Video Tutor ផ្ទាល់ខ្លួន។",
    "កម្មវិធីចាក់នេះដំណើរការទាំងស្រុងលើអេក្រង់ផ្ទាំងក្រណាត់ដោយគ្មានស្លากវីដេអូណាមួយឡើយ。",
  ...
  lo: [
    "ยินดีต้อนรับเข้าสู่พื้นที่ทำงาน AI Video Tutor ที่กำหนดเอง.",
    "เครื่องเล่นนี้ทำงานอย่างสมบูรณ์ในหน้าจอผ้าใบโดยไม่มีแท็กวิดีโอใดๆ.",
    "ท่านสามารถปรับอัตราการเล่น, เลือกคำบรรยาย, หรือเปลี่ยนการแปลเสียงได้."
  ],
  lv: [
  ...
  ml: [
    "ഇഷ്ടാനுസൃത AI വീഡിയോ ട്യൂട്ടർ വർക്ക്സ്പേസിലേക്ക് സ്വാਗതം.",
    "ഈ പ്ലെയർ വീഡിയോ ടാഗുകൾ ഒന്നുമില്ലാതെ പൂർണ്ണമായും ക്യാൻവാസ് സ്ക്രീനിൽ പ്രവർത്തിക്കുന്നു.",
    "നിങ്ങൾക്ക് പ്ലേബാക്ക് നിരക്ക് ക്രമീകരിക്കാനും സബ്ടൈറ്റിലുകൾ തിരഞ്ഞെടുക്കാനും അല്ലെങ്കിൽ ഓഡിയോ വിവർത്തനങ്ങൾ മാറ്റാനും കഴியும்."
  ],
  mt: [
  ...
  mni: [
    ...
    "অদোম্না প্লেবেক রেত শেমদোক-শেমজিন তৌবা, সবতাইতল খনবা, নত্রগা অদিও হন্দোকপা য়াই।"
  ],
  mi: [
  ...
  or: [
    ...
    "ଆପଣ ପ୍ଲେବ୍ୟାକ୍ ହାର ସମାଯୋଜନ କରିପାରିବେ, ସବ୍‌ଟାଇଟଲ୍ ଚୟନ କରିପାରିବେ କିମ୍ବା ଅଡିଓ ଅନୁବାද ବଦଳାଇ ପାରିବେ।"
  ],
  om: [
  ...
  pa: [
    "ਕਸਟਮ AI ਵੀਡੀਓ ਟਿਊਟਰ ਵਰਕਸਪੇਸ ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਆਗત ਹੈ।",
  ...
  ru: [
    ...
    "Вы можете настроить скорость воспроизведения, выбрать субтитри или переключить аудиоперевод."
  ],
  sm: [
  ...
  sat: [
    "ᱠᱟᱥᱴᱚᱢ AI ᱵᱷᱤᱰᱤᱭᱳ ᱴᱤᱣᱴᱚᱨ ᱠᱟᱹᱢᱤ ᱴᱷᱟᱶ ᱨᱮ ᱥᱟᱹᱜᱩն ᱫᱟᱨᱟᱢ᱾",
    "ᱱᱚᱣᱟ ᱯᱞᱮᱭᱟᱨ ᱫᱚ ᱵᱷᱤᱰᱤᱭᱳ ᱴᱮᱜᱽ ᱵᱮᱜᱚᱨ ᱜᱮ ᱠᱮᱱᱵᱷᱟᱥ ᱥᱠᱨᱤᱱ ᱨᱮ ᱪᱟᱞᱟᱜᱼᱟ᱾",
    "ᱟᱢ ᱯᱞᱮᱵᱮᱠ ᱫᱚᱨ ᱥᱟᱡᱟᱣ, ᱥᱟᱵᱽᱴᱟᱭᱤᱴᱮᱞ ᱵᱟᱪᱷᱟᱣ ᱥᱮ ᱟᱲᱟᱝ ᱛᱚᱨᱡᱚམᱟ ᱵᱚᱫᱚល ᱫᱟᱲေᱭᱟᱜᱼᱟᱢ᱾"
  ],
  sr: [
  ...
  ta: [
    "தனிப்பயன் AI வீடியோ ட்யூட்டர் பணியிடத்திற்கு வரவேற்கிறோம்.",
  ...
  ur: [
    "کسٹم AI ویڈیو ٹیوٹر ورک اسپیس में खुश आमादीद।",
    "यह प्लेयर बिना किसी वीडियो टैग के पूरी तरह से कैनवास स्क्रीन पर चलता है।",
    "आप प्लेबैक की दर को समायोजित कर सकते हैं, सबटाइटल्स चुन सकते हैं, या ऑडियो अनुवाद बदल सकते हैं।"
  ],
  uz: [
